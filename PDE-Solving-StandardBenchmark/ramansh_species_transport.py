...
parser.add_argument('--project-name', type=str, default='ramansh_transolver-species_transp')
...
def main():
    ...
    if args.div_loss or args.calc_div:
        ...
        interior_mask = build_interior_mask(physical_grid, cylindrical=True).cuda()
