...
#sp "python3 ramansh_airfoil.py --ntrain=1000 --norm-grid --wandb --slice-num=$ns"
#done
#
#for nl in 3 5; do
#sp "python3 ramansh_airfoil.py --ntrain=1000 --norm-grid --wandb --n-layers=$nl"
#done
#
#for nh in 64 128; do
#sp "python3 ramansh_airfoil.py --ntrain=1000 --norm-grid --wandb --n-hidden=$nh"
#done
#
#for nh in 6 8; do
#sp "python3 ramansh_airfoil.py --ntrain=1000 --norm-grid --wandb --n-heads=$nh"
#done
#
