...
for ktrain in 1 5 10 15 20 25 30; do
for seed in 1 2 3; do
sp "python3 -u manifold_many.py --seed=$seed --n-heads=6 --batch-size=50 --norm-grid=3 --n-hidden=64 --n-layers=4 --slice-num=32 --epochs=500 --k-train=$ktrain --problem='rd' --wandb"
done
done
