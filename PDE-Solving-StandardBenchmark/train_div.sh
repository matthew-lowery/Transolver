...
for seed in 2 3; do
    ...
    div_loss_weight=0.1
    sp "python3 ramansh_2d.py --data-root=/projects/bgcs/mlowery/ram_dataset --project-name=transolver_div_loss --div-folder=/projects/bfel/mlowery/transolver-div-loss/lambda-$div_loss_weight/divs --model-folder=/projects/bfel/mlowery/transolver-div-loss/lambda-$div_loss_weight/models --model=Transolver_Irregular_Mesh --epochs=500 --batch-size=20 --lr=1e-3 --weight_decay=1e-5 --mlp_ratio=1 --dropout=0.0 --downsample=1 --ref=8 --unified_pos=0 --gpu=0 --wandb --calc-div --save --norm-grid --div-loss --div-loss-weight=$div_loss_weight --seed=$seed --dataset=taylor_green --ntrain=5000 --n-hidden=128 --n-layers=5 --n-heads=4 --slice-num=64" 2 "div_taylor_green"

    div_loss_weight=0.1
    sp "python3 ramansh_taylor_green_coeffs2.py --data-root=/projects/bgcs/mlowery/ram_dataset --project-name=transolver_div_loss --div-folder=/projects/bfel/mlowery/transolver-div-loss/lambda-$div_loss_weight/divs --model-folder=/projects/bfel/mlowery/transolver-div-loss/lambda-$div_loss_weight/models --model=Transolver_Irregular_Mesh --epochs=500 --batch-size=20 --lr=1e-3 --weight_decay=1e-5 --mlp_ratio=1 --dropout=0.0 --downsample=1 --ref=8 --unified_pos=0 --gpu=0 --wandb --calc-div --save --norm-grid --div-loss --div-loss-weight=$div_loss_weight --seed=$seed --dataset=taylor_green_coeffs --ntrain=5000 --n-hidden=64 --n-layers=4 --n-heads=6 --slice-num=32" 10 "div_taylor_green_coeffs"

    div_loss_weight=0.01
    sp "python3 ramansh_taylor_green_time.py --data-root=/projects/bgcs/mlowery/ram_dataset --project-name=transolver_div_loss --div-folder=/projects/bfel/mlowery/transolver-div-loss/lambda-$div_loss_weight/divs --model-folder=/projects/bfel/mlowery/transolver-div-loss/lambda-$div_loss_weight/models --model=Transolver_Irregular_Mesh --epochs=500 --batch-size=20 --lr=1e-3 --weight_decay=1e-5 --mlp_ratio=1 --dropout=0.0 --downsample=1 --ref=8 --unified_pos=0 --gpu=0 --wandb --calc-div --save --norm-grid --div-loss --div-loss-weight=$div_loss_weight --seed=$seed --dataset=taylor_green_spacetime --ntrain=5000 --n-hidden=64 --n-layers=5 --n-heads=6 --slice-num=32" 2 "div_taylor_green_spacetime"

    div_loss_weight=0.1
    sp "python3 ramansh_taylor_green_time_coeffs2.py --data-root=/projects/bgcs/mlowery/ram_dataset --project-name=transolver_div_loss --div-folder=/projects/bfel/mlowery/transolver-div-loss/lambda-$div_loss_weight/divs --model-folder=/projects/bfel/mlowery/transolver-div-loss/lambda-$div_loss_weight/models --model=Transolver_Irregular_Mesh --epochs=500 --batch-size=20 --lr=1e-3 --weight_decay=1e-5 --mlp_ratio=1 --dropout=0.0 --downsample=1 --ref=8 --unified_pos=0 --gpu=0 --wandb --calc-div --save --norm-grid --div-loss --div-loss-weight=$div_loss_weight --seed=$seed --dataset=taylor_green_spacetime_coeffs --ntrain=5000 --n-hidden=64 --n-layers=5 --n-heads=6 --slice-num=32" 10 "div_taylor_green_spacetime_coeffs"
    ...
    div_loss_weight=0.001
    sp "python3 ramansh_species_transport.py --data-root=/projects/bgcs/mlowery/ram_dataset --project-name=transolver_div_loss --div-folder=/projects/bfel/mlowery/transolver-div-loss/lambda-$div_loss_weight/divs --model-folder=/projects/bfel/mlowery/transolver-div-loss/lambda-$div_loss_weight/models --model=Transolver_Irregular_Mesh --epochs=500 --batch-size=20 --lr=1e-3 --weight_decay=1e-5 --mlp_ratio=1 --dropout=0.0 --downsample=1 --ref=8 --unified_pos=0 --gpu=0 --wandb --calc-div --save --norm-grid --div-loss --div-loss-weight=$div_loss_weight --seed=$seed --dataset=species_transport --ntrain=10000 --n-hidden=128 --n-layers=5 --n-heads=4 --slice-num=32" 10 "div_species_transport"
